...
<!--This can work for the all posts and reading a single post at a time when you click on the post title. each page can be assigned an id and similar to the above principle you can show them.

above was a good idea but what about the mobile users.-->